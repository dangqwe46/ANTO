...
// </copyright>
// <author></author>
// <date>12/16/2021 10:39:44 AM</date>
...
namespace ANT.EO.Plugin.ApprovalConfigLine
{
    /// <summary>
    ...
    /// </summary>    
    public abstract class CheckOverlap : IPlugin
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CheckOverlap"/> class.
        /// </summary>
        /// <param name="pluginClassName">The <see cref=" cred="Type"/> of the derived class.</param>
        [System.Diagnostics.CodeAnalysis.SuppressMessage("Microsoft.Performance", "CA1811:AvoidUncalledPrivateCode", Justification = "PluginBase")]
        internal CheckOverlap(Type pluginClassName)
        {
